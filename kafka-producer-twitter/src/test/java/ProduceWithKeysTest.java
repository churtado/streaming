        import com.github.churtado.kafka.twitter.TwitterProducer;
...
public class ProduceWithKeysTest {
    ...
    @BeforeEach
    public void setup() {
        logger = LoggerFactory.getLogger(ProduceWithKeysTest.class.getName());
    ...
    @Test
    @DisplayName("Produce a Tweet with a key")
    public void TestOneProduceWithKey() throws IOException {
        String msg = null;
        ...
        if (msg != null){
            ...
            producer.send(new ProducerRecord<String, String>("keyed_twitter_tweets", id, msg), new Callback() {
                @Override
    ...
    @Test
    @DisplayName("Produce a stream of tweets")
    public void ProduceStream() throws IOException {
